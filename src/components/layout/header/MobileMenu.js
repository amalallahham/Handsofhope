						...
						<div className="hamburger_top d-flex align-items-center justify-content-between">
							<div className="hamburger_logo">
								<Link href="/" className="mobile_logo">
									<Image src="/images/logos/hands-of-hope-white-logo.png" alt="Logo" width={100} height={50} style={{ height: "auto", display: "block" }} />
								</Link>
							</div>
						...
						<div className="hamburger-infos">
							...
							<div className="contact-info">
								<div className="contact-item">
									...
									<Link className="contact-link" href="tel:+12363359951">
										+1 (236) 335-9951
									</Link>
								</div>
								<div className="contact-item">
									<span className="subtitle">Email</span>
									<Link className="contact-link" href="mailto:info@handsofhopeorg.ca">
										info@handsofhopeorg.ca
									</Link>
								</div>
